...
import { Eye, Heart, Clock, Star, ArrowRight } from 'lucide-react';
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <div className={`absolute inset-0 flex items-center justify-center transition-all duration-300 ${
          ...
          <button className="bg-white/90 backdrop-blur-sm text-gray-900 px-6 py-3 rounded-full font-medium flex items-center space-x-2 shadow-xl hover:bg-white transition-all duration-200 transform hover:scale-105">
